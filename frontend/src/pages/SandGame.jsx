...
import { ArrowLeft, Info, Flower2, ExternalLink } from "lucide-react";
import GameEmbed from "../components/GameEmbed"; // keep using your GameEmbed

export default function SandGame() {
  const navigate = useNavigate();
  return <SandGameView />;   // ✅ render the unchanged view
}

function SandGameView() {
  return (
        ...
        <div className="mb-5 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-slate-600">
              A calm sandbox you can play instantly—no login, no data entry.
            </p>
          </div>
        </div>
